...
#line 29 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 30 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 37 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 38 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
#line 1 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\queue.h"
...
#line 41 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\queue.h"
...
#line 76 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\queue.h"
...
#line 39 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 91 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 253 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 364 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 414 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 535 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
 

#line 566 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
 

#line 592 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 717 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
			...
			if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
			{
				...
				UBaseType_t uxPreviousMessagesWaiting = pxQueue->uxMessagesWaiting;
					...
					if( pxQueue->pxQueueSetContainer != 0 )
					{
						...
						else if( prvNotifyQueueSetContainer( pxQueue, xCopyPosition ) != ( ( BaseType_t ) 0 ) )
						{
...
#line 873 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 1086 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
			}
			else
			{
...
Queue_t * const pxQueue = xQueue;
	...
	if( ( !( ( pxQueue ->pcHead == 0 ) && ( pxQueue ->u . xSemaphore . xMutexHolder != 0 ) ) ) == 0 ) { __disable_irq(); for( ;; ); };
...
#line 1251 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
			}
			else
			{
		...
		vPortEnterCritical();
		{
			...
			else
			{
				if( xTicksToWait == ( TickType_t ) 0 )
				{
					...
					{
						if( ( xInheritanceOccurred == ( ( BaseType_t ) 0 ) ) == 0 ) { __disable_irq(); for( ;; ); };
					}
...
#line 2010 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
}
...
#line 2247 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
...
#line 2442 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
 

#line 2532 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
 

#line 2580 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
 

#line 2640 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\queue.c"
	...
	BaseType_t xReturn = ( ( BaseType_t ) 0 );
		...
		if( ( pxQueueSetContainer ) == 0 ) { __disable_irq(); for( ;; ); };
		if( ( pxQueueSetContainer->uxMessagesWaiting < pxQueueSetContainer->uxLength ) == 0 ) { __disable_irq(); for( ;; ); };
