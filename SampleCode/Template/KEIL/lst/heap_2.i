...
#line 38 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
#line 45 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
#line 46 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
static void prvHeapInit( void );
	...
	static uint8_t ucHeap[ ( ( size_t ) ( 5 * 1024 ) ) ];
...
static size_t xFreeBytesRemaining = ( ( ( size_t ) ( 5 * 1024 ) ) - 8 );
...
#line 116 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
void *pvReturn = 0;
	...
	vTaskSuspendAll();
	{
		...
		if( ( xWantedSize > 0 ) && ( xWantedSize < ( ( ( size_t ) ( 5 * 1024 ) ) - 8 ) ) )
		{
...
uint8_t *pucAlignedHeap;
	...
	xEnd.xBlockSize = ( ( ( size_t ) ( 5 * 1024 ) ) - 8 );
	xEnd.pxNextFreeBlock = 0;

	
 
	pxFirstFreeBlock = ( void * ) pucAlignedHeap;
	pxFirstFreeBlock->xBlockSize = ( ( ( size_t ) ( 5 * 1024 ) ) - 8 );
