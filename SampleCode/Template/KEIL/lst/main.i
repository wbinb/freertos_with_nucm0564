...
#line 18 "..\\main.c"
#line 1 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 36 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 103 "..\\..\\..\\ThirdParty\\FreeRTOS\\Source\\include\\semphr.h"
...
void SYS_Init(void)
{
    ...
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPD_MFPL = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPD_MFPL & (~(0xful << (0)))) | (0x3UL<<(0));
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPD_MFPL = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPD_MFPL & (~(0xful << (4)))) | (0x3UL<<(4));
...
int32_t main(void)
{
	...
	xTaskCreate( vStartLEDFlashTasks, "LED", ( ( unsigned short ) 50 ), 0, 1, ( TaskHandle_t * ) 0 );
...
{    
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)), 0x00000200, 0x1UL);
    ...
    while(1)
	{
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((9)<<2)))) ^= 1;
		printf("led blink\n");
		vTaskDelay( 1000 );
	}
}
